...
public class Live2DManager : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        */
        ...
        if (faceParam.Sleep)
        {
            mouthParameter.Value = 0.0f;
            reyeParameter.Value = 0.0f;
            leyeParameter.Value = 0.0f;
            faceYawParameter.Value = 6.0f;
            facePitchParameter.Value = -30.0f;
            faceRollParameter.Value = 30.0f;
            return;
        }
